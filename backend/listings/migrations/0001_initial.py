    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('Para Venda', 'For Sale'), ('Para Arrendar', 'For Rent')], default='Para Venda', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('Casa', 'House'), ('Condominio', 'Condo'), ('Casa_da_Cidade', 'Townhouse')], default='Casa', max_length=50)),
